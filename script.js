...
// Create a reference to the element whose ID is 'big_coffee and call it bigCoffee
const bigCoffee = document.getElementById("big_coffee");
// Create a reference to the element whose ID is 'producer_container' and call it producerContainer
